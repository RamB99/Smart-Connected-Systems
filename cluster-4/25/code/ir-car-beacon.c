...
void app_main()
{
    ...
    led_init();
    button_init();
    xTaskCreate(get_task, "uart_rx_task", 1024 * 4, NULL, configMAX_PRIORITIES, NULL);
    xTaskCreate(change_led, "set_traffic_task", 1024 * 2, NULL, configMAX_PRIORITIES, NULL);
